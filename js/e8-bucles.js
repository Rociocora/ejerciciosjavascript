...
1. Iniciamos el contador a 0. 
2. Definimos el numero de repeticiones. 
3. Incrementamos con i++ para que el contandor vaya avanzando*/
...
//EJEMPLO 3: MOSTRAR LISTA EN MINUSUCULAS
function mostrarListaMinuscula(){
    let listaNombres = ["María","Ana","paBlo","maNuel","katiA"];
    let longitud = listaNombres.length;
    let mensaje = "";

    for (let i=0; i<longitud; i++){

        if(listaNombres[i]=== "María"){
...
//WHILE
/*While se usa cuando queremos repetir el mismo codigo pero no sabemos cuantas veces. Queremos repetirlo hasta que 
se cumpla una condicion concreta.*/
