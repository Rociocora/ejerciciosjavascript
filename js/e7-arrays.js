/*VARIABLES GLOBALES: ESTAN FUERA DE LA FUNCION, Y PUEDE USARSE DENTRO DE CUALQUIER 
FUNCION QUE ESTE EN EL MISMO FICHERO JS*/
...
function mostrarInfoLista () {
    ...
    " el primer elemento de la lista es " + primerProducto + 
    " el ultimo elemento de la lista es " + ultimoProducto + 
    " la longitud de la lista es " + longitudLista;
...
//splice(posicion,numero de elementos a eliminar) recordar que la posicion empieza en 0.
